...
public class LoadingLayout extends FrameLayout {
    ...
    public LoadingLayout(Context context, AttributeSet attrs) {
        ...
        pageBackground = a.getColor(R.styleable.LoadingLayout_pageBackground, getResources().getColor(R.color.base_loading_background));
        a.recycle();
    }
    ...
    private void build() {
        ...
        errorText.setTextColor(getResources().getColor(mConfig.tipTextColor));
        emptyText.setTextColor(getResources().getColor(mConfig.tipTextColor));
        networkText.setTextColor(getResources().getColor(mConfig.tipTextColor));
